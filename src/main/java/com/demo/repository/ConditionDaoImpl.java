...
public class ConditionDaoImpl implements ConditionDao {
	...
	public List<Condition> findAll(String user_name) {
		...
		String sql = "SELECT * FROM `condition` WHERE `condition`.user_name LIKE \"" + user_name
				+ "\" ORDER BY `day` ASC;";
	...
	public List<Condition> findByDate(String date_from, String date_to, String user_name) {
		String sql = "SELECT * FROM `condition` WHERE day BETWEEN \"" + date_from + "\" AND \"" + date_to
				+ "\" AND `condition`.user_name LIKE \"" + user_name + "\" ORDER BY `day` ASC;";
		List<Map<String, Object>> resultList = jdbcTemplate.queryForList(sql);
	...
	public List<Condition> findMental(String graph_from, String graph_to, String user_name) {
		String sql = "SELECT mental FROM `condition` WHERE day BETWEEN \"" + graph_from + "\" AND \"" + graph_to
				+ "\" AND `condition`.user_name LIKE \"" + user_name + "\" ORDER BY `day` ASC;";
	...
	public List<Condition> findDay(String graph_from, String graph_to, String user_name) {
		String sql = "SELECT day FROM `condition` WHERE day BETWEEN \"" + graph_from + "\" AND \"" + graph_to
				+ "\" AND `condition`.user_name LIKE \"" + user_name + "\" ORDER BY `day` ASC;";
		RowMapper<Condition> rowMapper = new BeanPropertyRowMapper<Condition>(Condition.class);
