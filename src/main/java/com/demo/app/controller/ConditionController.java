...
//    	System.out.println(result);
	...
	@GetMapping("/search")
	public String dateSearch(Condition condition, Model model, @ModelAttribute("date_from") String date_from, @ModelAttribute("date_to") String date_to, 
...
//		System.out.println(condition.getUser_name());
	...
	@GetMapping("/graph")
	public String graph(Model model, @ModelAttribute("graph_from") String graph_from, @ModelAttribute("graph_to") String graph_to, 
			@AuthenticationPrincipal UserDetailsImpl userDetails) {
		String user_name = userDetails.getUsername();
...
//		String[] dayArray = Arrays.asList(DayArray).toArray(new String[DayArray.length]);
